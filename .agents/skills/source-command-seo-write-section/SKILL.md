...
`seo-growth-navigator` Skill の **Step 5**。詳細手順は [references/sop.md](../../skills/seo-growth-navigator/references/sop.md) の Step 5 を参照。
共通の執筆スタイルは [references/writing-style.md](../../skills/seo-growth-navigator/references/writing-style.md) を参照。
...
2. **執筆**
   ...
   - スタイルは [writing-style.md](../../skills/seo-growth-navigator/references/writing-style.md) に厳格に従う
...
詳細とプロンプト構成は [sop.md の Step 5-B](../../skills/seo-growth-navigator/references/sop.md) を参照。
...
4. **残りの H2 をすべて並列起動**
   ...
   - 各 Agent に渡すプロンプトの構成は [sop.md の Step 5-B 手順 3](../../skills/seo-growth-navigator/references/sop.md) に従う:
     - 担当 H2 のメタ情報(id, 見出し, 要点, H3 構造)
     - 書かない範囲(他 H2 のタイトルと要点)
     - SERP 要約(`03-serp-summary.md`)
     - 文体見本(`05-drafts/h2-01.md` の本文)
     - 共通スタイル([writing-style.md](../../skills/seo-growth-navigator/references/writing-style.md) 全文)
     - データ整合性ルール([data-integrity.md](../../skills/seo-growth-navigator/references/data-integrity.md))
...
- 数値は MCP 実数のみ([data-integrity.md](../../skills/seo-growth-navigator/references/data-integrity.md))
