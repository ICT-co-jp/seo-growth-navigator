...
`seo-growth-navigator` Skill の **Step 1** を実行します。詳細手順は [references/sop.md](../../skills/seo-growth-navigator/references/sop.md) を参照。
...
4. **URL名寄せ & タイプ分類** (詳細: [data-integrity.md](../../skills/seo-growth-navigator/references/data-integrity.md))
